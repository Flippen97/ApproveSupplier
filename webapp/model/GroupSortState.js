sap.ui.define([
	...
	return BaseObject.extend("zapp.model.GroupSortState", {
		 ...
		 * @alias zapp.model.GroupSortState
		 */
		...
		/**
		 * Sorts by CompanyCode, or by GrossAmount
		 *
		...
		group: function (sKey) {
			...
			if (sKey === "GrossAmount") {
				...
				this._oViewModel.setProperty("/sortBy", "CompanyCode");
			}
